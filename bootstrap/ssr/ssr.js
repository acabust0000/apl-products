...
const appName = "Apl Products";
createServer(
  (page) => createInertiaApp({
    page,
    render: renderToString,
    title: (title) => `${title} - ${appName}`,
    resolve: (name) => resolvePageComponent(`./pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./pages/about/components/Product.vue": () => import("./assets/Product-Dv37c6Tc.js"), "./pages/about/index.vue": () => import("./assets/index-B8pn7lce.js"), "./pages/blog/List.vue": () => import("./assets/List-BmpDoZOp.js"), "./pages/blog/components/Article.vue": () => import("./assets/Article-DxDlbaAC.js"), "./pages/blog/components/Socials.vue": () => import("./assets/Socials-xCfh-Nby.js"), "./pages/blog/index.vue": () => import("./assets/index-DGYEmpEa.js"), "./pages/contact/index.vue": () => import("./assets/index-mvCzFjrJ.js"), "./pages/gallery/List.vue": () => import("./assets/List-B5Jb5Km7.js"), "./pages/gallery/components/Gallery.vue": () => import("./assets/Gallery-CIV5BME0.js").then((n2) => n2.G), "./pages/legal/index.vue": () => import("./assets/index-BgegjmOU.js") })),
